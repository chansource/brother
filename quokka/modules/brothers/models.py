...
class BrotherInfo(Content):
    ...
    brother_college_major = db.StringField(max_length=255, required=True) # 师兄专业
    brother_college_name = db.StringField(max_length=255, required=True) # 师兄毕业院校
    brother_tags = db.ListField(db.StringField(max_length=255), required=False) # 师兄标签
    ...
    brother_article = db.ReferenceField(BrotherArticles, required=False) # 文章信息
